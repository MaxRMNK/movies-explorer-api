...
const createUser = (req, res, next) => {
  ...
  // Валидация пароля до хэширования, т.к. потом этого уже не сделать.
  // Здесь же можно добавить проверку на наличие цифр, заглавных и строчных букв и спецсимволов
  if (password.length < 6 || password.length > 30) {
    throw new ValidationError('Длина пароля должна быть от 6 до 30 символов');
    // 'Ошибка валидации, переданы некорректные данные'
  }
